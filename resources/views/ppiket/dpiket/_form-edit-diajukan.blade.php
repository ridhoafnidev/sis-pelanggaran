...
<div class="table-responsive">
    <span id="result"></span>
        ...
        <div class="form-group">
            ...
            <select name="guru_id" class="form-control input-lg" readonly="true">
        ...
        <div class="form-group">
            ...
            <select name="kehadiran_id" class="form-control input-lg" readonly="true">
        ...
        <div class="form-group"> 
            ...
            <input class="form-control" required="required" name="nama_petugas" type="text" value="{{$pelanggaran[0]->nama_petugas}}" readonly/>
...
$(document).ready(function(){
 ...
 function dynamic_field(number)
 {
  html = '<tr>';
        ...
        html += '<td><select name="pelanggaran" class="form-control input-lg" readonly="true"><option value="">== Pilih Pelanggaran ==</option>@foreach ($jpelanggaran as $pelanggaran)<option value="{{ $pelanggaran->id }}" <?php if($pelanggaran->id == $dataPelanggaran[0]->jenis_pelanggaran_id){ echo "selected"; }?>>{{  $pelanggaran->jenis_pelanggaran }}</option>@endforeach</select></td>';
        if(number > 1)
        {
