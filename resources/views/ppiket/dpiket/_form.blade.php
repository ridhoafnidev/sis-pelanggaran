...
$(document).ready(function(){
 ...
 function dynamic_field(number)
 {
  html = '<tr>';
        ...
        html += '<td><select name="pelanggaran[]" class="form-control input-lg"><option value="">-Pilih Pelanggaran-</option>@foreach($jpelanggaran as $pelanggaran)<option value="{{ $pelanggaran->id }}">{{$pelanggaran->jenis_pelanggaran}}</option>@endforeach</select></td>';
        if(number > 1)
        {
