    ...
    @if(Session::has('success'))
        ...
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-list"></i> Rekap Pelanggaran Siswa <button class="btn btn-sm btn-outline-primary" id="btn_download"><i class="fa fa-download"></i> Unduh</button>
...
<script>
    $(document).ready(function(){
        ...
        function fill_datatable(filter_ta = ''){
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('wakasis.wakasis.index') }}",
