...
<div class="table-responsive">
    <span id="result"></span>
        ...
        <div class="form-group"> 
            ...
            <textarea class="form-control" readonly name="deskripsi_penanganan" type="text" rows="2" >{{$pelanggaran[0]->deskripsi_penanganan}}</textarea> 
        </div>

        <div class="form-group"> 
            <label for="title">Hasil Konseling</label>
            <textarea class="form-control" readonly name="hasil_konseling" type="text" rows="2" >{{$pelanggaran[0]->hasil_konseling}}</textarea> 
        </div>

        <div class="form-group"> 
            <label for="title">Rekomendasi</label>
            <textarea class="form-control" readonly name="rekomendasi" type="text" rows="2" >{{$pelanggaran[0]->rekomendasi}}</textarea> 
        </div>

        <div class="form-group"> 
            <label for="title">Konseler</label>
            <input class="form-control" readonly required="required" name="konseler" type="text" value="{{$pelanggaran[0]->konseler}}"/>
        </div>
    ...
    <a href="{{route('wakasis.wakasis.cetak.rsiswa',$data->id)}}" class="btn btn-primary">Print</a>      
    </div>
