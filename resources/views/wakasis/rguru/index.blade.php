...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{route('wakasis.index')}}">Rekap Kehadiran Guru</a>
        </li>
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-list"></i> Rekap Kehadiran Guru <button class="btn btn-sm btn-outline-primary" id="btn_download"><i class="fa fa-download"></i> Unduh</button>
...
<script>
    $(document).ready(function() {
        ...
        function download_data(filter_ta = ''){
            //alert(filter_ta);
            var url = "{{ route('wakasis.wakasis.cetak.rguru', "") }}"+"/"+filter_ta;
            window.location = url;
        }
        ...
        function fill_datatable(filter_ta = ''){
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('wakasis.wakasis.rguru') }}",
